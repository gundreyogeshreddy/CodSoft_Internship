...
title_label = ttk.Label(window, text="Rock-Paper-Scissors Game", style="TLabel", foreground="red")
...
user_score_label.pack(padx=100)

computer_score_label = ttk.Label(window, text="Computer Score: 0", style="TLabel", font=("Helvetica", 12), foreground="indigo")
computer_score_label.pack(padx=100)

round_number = 1
round_label = ttk.Label(window, text=f"Round: {round_number}", style="TLabel")
round_label.pack(pady=100)
