...
f4 = Frame(f)
Label(f4, text="𝓟𝓪𝓼𝓼𝔀𝓸𝓻𝓭 𝓖𝓮𝓷𝓮𝓻𝓪𝓽𝓸𝓻", font="comicsans 18").pack(side=LEFT)
f4.pack(pady=20)
...
b = Button(text="GENERATE PASSWORD", font="comicsans 14 bold", bg="white", fg="dark red", borderwidth=3, command=pswd_generator)
b.pack()

b2 = Button(text="ACCEPT", font="comicsans 14", bg="white", fg="indigo", borderwidth=3)
b2.pack(pady=20)

b3 = Button(text="REJECT", font="comicsans 14", bg="black", fg="orange", borderwidth=3)
b3.pack()
